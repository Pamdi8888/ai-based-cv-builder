...
# data: {'full_name': 'Param Gandhif', 'date_of_birth': '2024-07-17', 'mail': 'paradsfmagandhi@gmail.com', 'dream_sector1': '', 'dream_sector2': '', 'career_plans': '', 'additional_info': '', 'minor_course_details': '', 'skills': [{'skill': '1'}, {'skill': '2'}], 'subjects': [{'subject': 'a'}, {'subject': 'b'}], 'transaction_id': '', 'prof_summary': '', 'format': 'professional', 'languages': [{'language': '', 'proficiency': ''}], 'education': [{'grad_year': '', 'percentage_cgpa': '', 'specialization': '', 'institution': '', 'board_university': ''}], 'projects': [{'title': '', 'domain': '', 'duration': '', 'description': '', 'url': ''}], 'social_accounts': [{'name': '', 'url': ''}], 'work_experience': [{'role': '', 'duration': '', 'description': '', 'organization': ''}], 'volunteer_activities': [{'role': '', 'date': '', 'description': '', 'organization': ''}], 'accomplishments': [{'name': '', 'description': '', 'date': '', 'organization': ''}], 'positions_of_responsibility': [{'role': '', 'date': '', 'description': '', 'organization': ''}], 'extra_curriculars': [{'name': '', 'category': '', 'description': ''}], 'certifications': [{'name': '', 'date': '', 'organization': ''}], 'competitions': [{'name': '', 'date': '', 'position': '', 'organization': ''}], 'conferences_workshops': [{'name': '', 'date': '', 'description': '', 'organization': ''}], 'test_scores': [{'name': '', 'date': '', 'score': ''}], 'patents_publications': [{'name': '', 'date': '', 'description': '', 'organization': ''}], 'scholarships': [{'name': '', 'date': '', 'description': '', 'organization': ''}]}
